...
1. Prevention of false positive associations due to population or relatedness structure 
2. An increase in power obtained through the application of a correction that is specific to this structure. 
3. LMM can also increase power in studies without sample structure by implicitly conditioning on associated loci other than the candidate locus. 

## Pitfalls of LMM

1. Computational complexity: 
- Building the GRM ($M \times M$ matrix with $M > 500.000$ )
- Estimating the mean and variance components ($N > 70000$) for each candidate SNP! 
